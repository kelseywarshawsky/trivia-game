$(document).ready(function () {
  ...
  var questions = [
    ...
    {
      question: "What color of cat is typically female?",
      choices: ["Black", "White", "Calico", "Orange"],
      correctAnswer: "Calico",
    },
    {
      question:
        "Cats have a unique print like the human's fingerprint, but where is it located??",
